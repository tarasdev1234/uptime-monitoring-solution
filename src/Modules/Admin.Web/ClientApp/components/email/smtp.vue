                                    ...
                                    <td class="m-datatable__cell--center m-datatable__cell m-datatable__cell--check">
                                        <span style="width: 100px;">
                                            <label class="m-checkbox m-checkbox--single m-checkbox--solid m-checkbox--brand">
                                                <input type="checkbox" onclick="return false;" :checked="srv.default"><span></span>
                                            </label>
                                        </span>
                                    </td>
                ...
                <div class="modal-content">
                    ...
                    <form @submit.prevent="saveServer()">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label class="m-checkbox m-checkbox--single m-checkbox--solid m-checkbox--brand">
                                    <input type="checkbox" v-model="currentServer.default"><span></span> Default
                                </label>
                            </div>
                    ...
                    <form @submit.prevent="createServer()">
                        <div class="modal-body">
                            ...
                            <div class="form-group" id="serverName">
                                ...
                                <input required v-model="currentServer.serverName" type="text" class="form-control m-input">
                            </div>
                            <div class="form-group" id="serverPort">
                                <label class="form-control-label">
                                    Server Port:
                                </label>
                                <input required v-model="currentServer.serverPort" type="text" class="form-control m-input">
                            </div>
                            <div class="form-group">
                                <label class="m-checkbox m-checkbox--single m-checkbox--solid m-checkbox--brand">
                                    <input type="checkbox" v-model="currentServer.default"><span></span> Default
                            ...
                            <div class="form-group m-form__group" id="encryption">
                                <label>
                                    Encryption
                                </label>
                                <select v-model="currentServer.encryption" class="form-control m-input">
    ...
    export default {
        ...
        methods: {
            ...
            async editSrv(id) {
                ...
                try {
                    let response = await this.$http.get(AppSettings.ApiUrl + `api/settings/email/smtp/${id}`);
            ...
            async saveServer() {
                try {
                    let response = await this.$http.put(AppSettings.ApiUrl + "api/settings/email/smtp", this.currentServer);
            ...
            async createServer() {
                ...
                try {
                    let response = await this.$http.post(AppSettings.ApiUrl + "api/settings/email/smtp", this.currentServer);
