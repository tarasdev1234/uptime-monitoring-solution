                        ...
                        <table class="m-datatable__table" id="datatable" style="display: block; min-height: 300px;">
                            <thead class="m-datatable__head">
                                <tr class="m-datatable__row">
                                    ...
                                    <th class="m-datatable__cell">
                                        <span style="width: 150px;">Host</span>
                                    </th>
                                    <th class="m-datatable__cell">
                            ...
                            <tbody class="m-datatable__body">
                                <span v-if="servers.length == 0" class="m-datatable--error">No records found</span>
                                <tr :class="'m-datatable__row ' + (index % 2 == 1 ? 'm-datatable__row--even' : '')" v-for="(srv, index) in servers" :key="index">
                                    <td class="m-datatable__cell"><span style="width: 150px;">{{ srv.name }}</span></td>
                                    <td class="m-datatable__cell"><span style="width: 150px;">{{ srv.host }}</span></td>
                                    <td class="m-datatable__cell">
                                        <span style="width: 150px;">
                                            <span :class="'m-badge m-badge--wide m-badge--' + (healthClasses[srv.health])">
                                                {{ health[srv.health] }}
                                            </span>
                                        </span>
                                    </td>
                                    <td data-field="Actions" class="m-datatable__cell">
                                        <span style="overflow: visible; width: 70px;">
                                            <a @click="editServer(srv.id)" href="#" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Edit Details">
                                                <i class="la la-edit"></i>
                                            </a>
                                            <a @click="deleteServer(srv.id)" href="#" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Delete">
        ...
        <div class="modal fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form @submit.prevent="saveServer()" class="m-form m-form--fit m-form--label-align-right" style="">
                        <div class="modal-body" id="create_frm">
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-9">
                                    <input v-model="currentServer.name" class="form-control m-input" type="text">
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                <label class="col-3 col-form-label">
                                ...
                                <div class="col-9">
                                    <input v-model="currentServer.host" class="form-control m-input" type="text">
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="create_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form @submit.prevent="createServer()" id="create_frm">
                        <div class="modal-body">
                            <div class="form-group">
                                <label class="form-control-label">
                                    Name:
                                </label>
                                <input required v-model="currentServer.name" type="text" class="form-control">
                            </div>
                            <div class="form-group">
                                <label class="form-control-label">
                                    Host:
                                </label>
                                <input required v-model="currentServer.host" type="text" class="form-control" />
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">
...
<script>
    import ServerApi from "../../Services/uptime/servers";
