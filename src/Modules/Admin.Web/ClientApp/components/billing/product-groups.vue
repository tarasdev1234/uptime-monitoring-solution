                    ...
                    <div class="m_datatable m-datatable m-datatable--brand m-datatable--default m-datatable--loaded">
                        <table class="m-datatable__table" id="datatable" style="display: block; min-height: 300px;">
                            ...
                            <tbody class="m-datatable__body">
                                <span v-if="groups.length == 0" class="m-datatable--error">No records found</span>
                                <tr :class="'m-datatable__row ' + (index % 2 == 1 ? 'm-datatable__row--even' : '')" v-for="(grp, index) in groups" :key="index">
                                    <td class="m-datatable__cell"><span style="width: 150px;">{{ grp.name }}</span></td>
                                    <td class="m-datatable__cell"><span style="width: 150px;">{{ grp.brandName }}</span></td>
                                    <td class="m-datatable__cell m-datatable__cell--center"><span style="width: 150px;">{{ grp.productsCount }}</span></td>
                                    <td data-field="Actions" class="m-datatable__cell">
                                        <span style="overflow: visible; width: 70px;">
                                            <a @click="editGroup(grp.id)" href="#" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Edit details">
                                                <i class="la la-edit"></i>
                                            </a>
                                            <a @click="deleteGroup(grp.id)" href="#" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Delete">
        ...
        <div class="modal fade" id="create_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form @submit.prevent="createGroup()" class="m-form m-form--fit m-form--label-align-right" style="">
                        <div class="modal-body" id="create_frm">
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-9">
                                    <input v-model="currentGroup.name" class="form-control m-input" type="text">
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                <label class="col-3 col-form-label">
                                ...
                                <div class="col-9">
                                    <select v-model="currentGroup.brandId" class="form-control m-input">
        ...
        <div class="modal fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form @submit.prevent="saveGroup()" class="m-form m-form--fit m-form--label-align-right" style="">
                        <div class="modal-body" id="create_frm">
                            <div class="form-group m-form__group row">
                                <label class="col-3 col-form-label">
                                    Name
...
<script>
    ...
    export default {
        ...
        methods: {
            showModal(id) {
                this.currentGroup = Object.assign({}, this.newGroup);
                $("#" + id).modal();
            },
            ...
            async createGroup() {
                ...
                await BillApi.createProductGroup(
                    this.currentGroup,
                    (data) => {
                        this.notification("Group created", "success");
            ...
            async deleteGroup(id) {
                if (confirm("Are you sure you want to delete this item?")) {
                    await BillApi.deleteProductGroup(
                        id,
                        (data) => {
            ...
            async saveGroup() {
                await BillApi.saveProductGroup(
                    this.currentGroup,
                    (data) => {
