                        ...
                        <table class="m-datatable__table" id="datatable" style="display: block; min-height: 300px;">
                            <thead class="m-datatable__head">
                                <tr class="m-datatable__row">
                                    ...
                                    <th class="m-datatable__cell">
                                        <span style="width: 150px;">Group</span>
                                    </th>
                                    <th class="m-datatable__cell">
                            ...
                            <tbody class="m-datatable__body">
                                <span v-if="products.length == 0" class="m-datatable--error">No records found</span>
                                <tr :class="'m-datatable__row ' + (index % 2 == 1 ? 'm-datatable__row--even' : '')" v-for="(prd, index) in products" :key="index">
                                    <td class="m-datatable__cell"><span style="width: 150px;">{{ prd.name }}</span></td>
                                    <td class="m-datatable__cell"><span style="width: 150px;">{{ prd.productGroupName }}</span></td>
                                    <td data-field="Actions" class="m-datatable__cell">
                                        <span style="overflow: visible; width: 70px;">
                                            <a @click="editProduct(prd.id)" href="#" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Edit details">
                                                <i class="la la-edit"></i>
                                            </a>
                                            <a @click="deleteProduct(prd.id)" href="#" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Delete">
        ...
        <div class="modal fade" id="create_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form @submit.prevent="createProduct()" class="m-form m-form--fit m-form--label-align-right" style="">
                        <div class="modal-body" id="create_frm">
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-9">
                                    <input v-model="currentProduct.name" class="form-control m-input" type="text">
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                <label class="col-3 col-form-label">
                                ...
                                <div class="col-9">
                                    <input v-model="currentProduct.price" class="form-control m-input" type="text">
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                <label class="col-3 col-form-label">
                                ...
                                <div class="col-9">
                                    <textarea v-model="currentProduct.description" class="form-control m-input">{{ currentProduct.description }}</textarea>
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                <label class="col-3 col-form-label">
                                ...
                                <div class="col-9">
                                    <select v-model="currentProduct.productGroupId" class="form-control m-input">
                                        <option v-for="g in groups" v-bind:value="g.id">
                                            {{ g.name }}
                                        </option>
                                    </select>
                                </div>
        ...
        <div class="modal fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form @submit.prevent="saveProduct()" class="m-form m-form--fit m-form--label-align-right" style="">
                        <div class="modal-body" id="create_frm">
                            <div class="form-group m-form__group row">
                                <label class="col-3 col-form-label">
                                    Name
...
<script>
    ...
    export default {
        ...
        methods: {
            showModal(id) {
                this.currentProduct = Object.assign({}, this.newProduct);
                $("#" + id).modal();
            },
            ...
            async deleteProduct(id) {
                if (confirm("Are you sure you want to delete this item?")) {
                    await BillApi.deleteProduct(
                        id,
                        (data) => {
                            this.notification("Group deleted", "success");
                            this.loadPage(this.currentPage);
                        },
                        (err) => this.notification(err, "danger")
                    );
            ...
            async loadDeps() {
                await BillApi.getProductGroups(
                    {},
                    (data) => {
