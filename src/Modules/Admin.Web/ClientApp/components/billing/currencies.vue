                        ...
                        <table class="m-datatable__table" id="datatable" style="display: block; min-height: 300px;">
                            <thead class="m-datatable__head">
                                <tr class="m-datatable__row">
                                    ...
                                    <th class="m-datatable__cell">
                                        <span style="width: 150px;">Format</span>
                                    </th>
                                    <th class="m-datatable__cell m-datatable__cell--center">
                                        <span style="width: 150px;">X-Rate</span>
                                    </th>
                                    <th class="m-datatable__cell">
                            ...
                            <tbody class="m-datatable__body">
                                <span v-if="currencies.length == 0" class="m-datatable--error">No records found</span>
                                <tr :class="'m-datatable__row ' + (index % 2 == 1 ? 'm-datatable__row--even' : '')" v-for="(curr, index) in currencies" :key="index">
                                    <td class="m-datatable__cell"><span style="width: 150px;">{{ curr.code }}</span></td>
                                    <td class="m-datatable__cell"><span style="width: 150px;">{{ curr.format.format }}</span></td>
                                    <td class="m-datatable__cell m-datatable__cell--center"><span style="width: 150px;">{{ curr.convertRate }}</span></td>
                                    <td data-field="Actions" class="m-datatable__cell">
                                        <span style="overflow: visible; width: 70px;">
                                            <a @click="editCurr(curr.id)" href="#" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Edit details">
                                                <i class="la la-edit"></i>
                                            </a>
                                            <a @click="deleteCurr(curr.id)" href="#" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Delete">
        ...
        <div class="modal fade" id="create_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form @submit.prevent="createCurr()" class="m-form m-form--fit m-form--label-align-right" style="">
                        <div class="modal-body" id="create_frm">
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-9">
                                    <input v-model="currentCurr.code" class="form-control m-input" type="text">
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                <label class="col-3 col-form-label">
                                ...
                                <div class="col-9">
                                    <input v-model="currentCurr.convertRate" class="form-control m-input" type="number">
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                <label class="col-3 col-form-label">
                                ...
                                <div class="col-9">
                                    <select v-model="currentCurr.brandId" class="form-control m-input">
                                        <option v-for="b in brands" v-bind:value="b.id">
                                            {{ b.name }}
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-9">
                                    <select v-model="currentCurr.formatId" class="form-control m-input">
                                        <option v-for="f in formats" v-bind:value="f.id">
                                            {{ f.format }}
                                        </option>
                                    </select>
                                </div>
        ...
        <div class="modal fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form @submit.prevent="saveCurrency()" class="m-form m-form--fit m-form--label-align-right" style="">
                        <div class="modal-body" id="create_frm">
                            <div class="form-group m-form__group row">
                                <label class="col-3 col-form-label">
                                    Code
...
<script>
    ...
    export default {
        ...
        methods: {
            showModal(id) {
                this.currentCurr = Object.assign({}, this.newCurr);
                $("#" + id).modal();
            },
            ...
            async createCurr() {
                ...
                await BillApi.createCurrency(
                    this.currentCurr,
                    (data) => {
                        this.notification("Currency created", "success");
            ...
            async deleteCurr(id) {
                if (confirm("Are you sure you want to delete this item?")) {
                    await BillApi.deleteCurrency(
                        id,
                        (data) => {
                            this.notification("Currency deleted", "success");
                            this.loadPage(this.currentPage);
                        },
                        (err) => this.notification(err, "danger")
                    );
            ...
            async loadDeps() {
                await BillApi.getCurrencyFormats(
                    (data) => {
