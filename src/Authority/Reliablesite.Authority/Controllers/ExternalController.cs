...
namespace Reliablesite.Authority.Controllers
{
    [SecurityHeaders]
    [AllowAnonymous]
    public class ExternalController : Controller
    {
        ...
        private async Task<IActionResult> ProcessWindowsLoginAsync(string returnUrl)
        {
            ...
            if (result?.Principal is WindowsPrincipal wp)
            {
                ...
                id.AddClaim(new Claim(JwtClaimTypes.Subject, wp.FindFirst(System.Security.Claims.ClaimTypes.PrimarySid).Value));
